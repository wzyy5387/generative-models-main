...
if __name__ == "__main__":
    ...
    for tag in ['wind', 'pv', 'load']:
        ...
        s_umnn = read_file(dir=str(scenarios_dir / 'nfs') + os.sep, name='scenarios_' + tag + '_UMNN_M_' + str(nf_umnn_id[tag]) + '_0_100_TEST')
        # s_an = read_file(dir=str(scenarios_dir / 'nfs') + os.sep, name='scenarios_' + tag + '_AN_M_'+str(nf_a_id[tag])+'_0_100_TEST')
        s_vae = read_file(dir=str(scenarios_dir / 'vae') + os.sep, name='scenarios_' + tag + '_VAElinear_1_0_100_TEST')
        s_gan = read_file(dir=str(scenarios_dir / 'gan') + os.sep, name='scenarios_' + tag + '_GAN_wasserstein_1_0_100_TEST')
        # s_gc = read_file(dir=str(scenarios_dir / 'gc') + os.sep, name='scenarios_' + tag +  '_gc_100_TEST')
        s_rand = read_file(dir=str(scenarios_dir / 'random') + os.sep, name='scenarios_' + tag + '_random_100_TEST')
